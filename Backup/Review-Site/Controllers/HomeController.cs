...
namespace Review_Site.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            Category cat = db.Categories.Single(x => x.ID == Guid.Parse("a323a95c-b475-4886-9f8d-006c2cc84c64"));
            return View("Index", cat);
        }
        [Restrict(Identifier="hello")]
        public ActionResult ForbiddenArea()
        {
        ...
        public ActionResult GetCategory(string id)
        {
            ...
            {
                if (!db.Grids.Any(x => x.ID == categoryguid)) throw new HttpException(404, "That category does not exist");
